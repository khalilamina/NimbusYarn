 ...
 * This file demonstrates how to integrate Nimbusyarn with a web frontend
 */

// For React/Vue/Angular applications
export class NimbusyarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NimbusyarnClient(provider, contractAddress);
